...
public class Compressor_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.io.InputStream", false, Compressor_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.io.OutputStream", false, Compressor_ESTest_scaffolding.class.getClassLoader()));
