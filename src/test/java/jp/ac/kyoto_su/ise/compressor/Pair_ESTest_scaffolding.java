...
public class Pair_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "jp.ac.kyoto_su.ise.compressor.Pair"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.function.BiConsumer", false, Pair_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.BiFunction", false, Pair_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.BiPredicate", false, Pair_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.Function", false, Pair_ESTest_scaffolding.class.getClassLoader()));
  }
